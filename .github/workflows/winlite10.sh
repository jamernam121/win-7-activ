...
curl -L -o lite10.qcow2 https://app.vagrantup.com/thuonghai2711/boxes/WindowsQCOW2/versions/1.1.0/providers/qemu.box
...
$endc$enda""";
sudo qemu-system-x86_64 -vnc :0 -hda lite10.qcow2  -smp cores=2  -m 4024M -machine usb=on -device usb-tablet > /dev/null 2>&1
sleep 43210
